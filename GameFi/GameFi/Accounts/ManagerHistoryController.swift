...
class ManagerHistoryController: UIViewController {
    var pageIndex = 1
    ...
    lazy var collectionView: UICollectionView = {
        ...
        layout.itemSize = CGSize(width: IPhone_SCREEN_WIDTH - 30, height: 390)
        // 设置CollectionView
        ...
        ourCollectionView.register(ManagerHistoryCell.classForCoder(), forCellWithReuseIdentifier: managerHistoryCellIdentifier)
...
extension  ManagerHistoryController : UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout{
...
//        appdelegate.homeVC?.navigationController!.pushViewController(scholarshipDetailVC, animated: true)
    ...
    func requestListData() {
        DataManager.sharedInstance.fetchManagerHistoryScholarShip(pageIndex: pageIndex) { result, reponse in
