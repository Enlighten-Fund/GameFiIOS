...
//  GameFi
//
//  Created by harden on 2021/12/30.
//

import Foundation
import UIKit
let MMRQRCellIdentifier:String = "MMRQRCell"
class MMRQRCell: TableViewCell {
    ...
    lazy var noticeLabel : UILabel = {
        ...
        tempLabel.text = "Upload the QR code of Axie Infinity to verify your highest MMR. Only for NinjaDAOs verification."
