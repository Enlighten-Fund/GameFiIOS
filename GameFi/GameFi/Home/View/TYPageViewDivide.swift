...
class TYPageViewDivide: UIView {

    private var titles = [String]()
    private var controllers = [UIViewController]()
    private weak var parentVc: UIViewController!
    var style: TYPageStyleDivide!
    ...
    //pageTitleView
    private lazy var pageTitleView: TYPageTitleViewDivide = {
        let pageTitleView = TYPageTitleViewDivide(frame: CGRect(x: 0, y: 0, width: self.bounds.width, height: self.style.labelHeight), titles: self.titles, style: self.style)
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        layout.itemSize = CGSize(width: self.bounds.size.width, height: self.bounds.size.height - self.style.labelHeight - CGFloat(IPhone_NavHeight) - CGFloat(IPhone_TabbarHeight))
    ...
    init(frame: CGRect,
         ...
         style: TYPageStyleDivide = TYPageStyleDivide()){
...
extension TYPageViewDivide : UICollectionViewDelegate,UICollectionViewDataSource{
...
extension TYPageViewDivide : TYPageTitleViewDivideDelegate{
    
    func pageView(pageView: TYPageTitleViewDivide, selectIndex: Int) {
