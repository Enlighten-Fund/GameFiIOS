...
protocol TYPageTitleViewDivideDelegate : class {
    func pageView(pageView:TYPageTitleViewDivide,selectIndex:Int)
}


class TYPageTitleViewDivide: UIView {

    weak var delegate:TYPageTitleViewDivideDelegate?
    
    fileprivate var style:TYPageStyleDivide!
    ...
    fileprivate var currentIndex:Int = 0
     ...
     init(frame: CGRect, titles: [String], style: TYPageStyleDivide) {
...
extension TYPageTitleViewDivide{
